...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rpl_panda_with_rs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alston/Panda-Object-Handling/src/rpl_panda_with_rs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alston/Panda-Object-Handling/devel/.private/rpl_panda_with_rs/lib;/home/alston/Panda-Object-Handling/devel/lib;/opt/ros/noetic/lib)
