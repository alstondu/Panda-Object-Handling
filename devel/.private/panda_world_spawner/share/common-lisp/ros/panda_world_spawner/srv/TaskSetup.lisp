...
(cl:defmethod cl:initialize-instance :after ((m <TaskSetup-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskSetup-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_world_spawner-srv:<TaskSetup-request> is deprecated: use panda_world_spawner-srv:TaskSetup-request instead.")))

(cl:ensure-generic-function 'task_index-val :lambda-list '(m))
(cl:defmethod task_index-val ((m <TaskSetup-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_world_spawner-srv:task_index-val is deprecated.  Use panda_world_spawner-srv:task_index instead.")
  (task_index m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TaskSetup-request>)))
  ...
  "panda_world_spawner/TaskSetupRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TaskSetup-request)))
  "Returns string type for a service object of type 'TaskSetup-request"
  "panda_world_spawner/TaskSetupRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TaskSetup-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TaskSetup-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_world_spawner-srv:<TaskSetup-response> is deprecated: use panda_world_spawner-srv:TaskSetup-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TaskSetup-response>)))
  ...
  "panda_world_spawner/TaskSetupResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TaskSetup-response)))
  "Returns string type for a service object of type 'TaskSetup-response"
  "panda_world_spawner/TaskSetupResponse")
