...
(cl:in-package object_handling-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <example-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'example-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_handling-srv:<example-request> is deprecated: use object_handling-srv:example-request instead.")))

(cl:ensure-generic-function 'example_float-val :lambda-list '(m))
(cl:defmethod example_float-val ((m <example-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_float-val is deprecated.  Use object_handling-srv:example_float instead.")
  (example_float m))

(cl:ensure-generic-function 'example_int-val :lambda-list '(m))
(cl:defmethod example_int-val ((m <example-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_int-val is deprecated.  Use object_handling-srv:example_int instead.")
  (example_int m))

(cl:ensure-generic-function 'example_string-val :lambda-list '(m))
(cl:defmethod example_string-val ((m <example-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_string-val is deprecated.  Use object_handling-srv:example_string instead.")
  (example_string m))

(cl:ensure-generic-function 'example_pose-val :lambda-list '(m))
(cl:defmethod example_pose-val ((m <example-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_pose-val is deprecated.  Use object_handling-srv:example_pose instead.")
  (example_pose m))
...
(cl:defmethod example_std_vector_of_poses-val ((m <example-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_std_vector_of_poses-val is deprecated.  Use object_handling-srv:example_std_vector_of_poses instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<example-request>)))
  ...
  "object_handling/exampleRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'example-request)))
  "Returns string type for a service object of type 'example-request"
  "object_handling/exampleRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <example-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'example-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_handling-srv:<example-response> is deprecated: use object_handling-srv:example-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <example-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:success-val is deprecated.  Use object_handling-srv:success instead.")
  (success m))
...
(cl:defmethod example_std_vector_of_points-val ((m <example-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_handling-srv:example_std_vector_of_points-val is deprecated.  Use object_handling-srv:example_std_vector_of_points instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<example-response>)))
  ...
  "object_handling/exampleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'example-response)))
  "Returns string type for a service object of type 'example-response"
  "object_handling/exampleResponse")
