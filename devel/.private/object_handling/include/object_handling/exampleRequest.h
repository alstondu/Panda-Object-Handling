// Generated by gencpp from file object_handling/exampleRequest.msg
// DO NOT EDIT!


#ifndef OBJECT_HANDLING_MESSAGE_EXAMPLEREQUEST_H
#define OBJECT_HANDLING_MESSAGE_EXAMPLEREQUEST_H
...
struct exampleRequest_
{
  ...
  typedef boost::shared_ptr< ::object_handling::exampleRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::object_handling::exampleRequest_<ContainerAllocator> const> ConstPtr;

}; // struct exampleRequest_

typedef ::object_handling::exampleRequest_<std::allocator<void> > exampleRequest;

typedef boost::shared_ptr< ::object_handling::exampleRequest > exampleRequestPtr;
typedef boost::shared_ptr< ::object_handling::exampleRequest const> exampleRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::object_handling::exampleRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::object_handling::exampleRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::object_handling::exampleRequest_<ContainerAllocator1> & lhs, const ::object_handling::exampleRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::object_handling::exampleRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::object_handling::exampleRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::object_handling::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::object_handling::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::object_handling::exampleRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::object_handling::exampleRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::object_handling::exampleRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::object_handling::exampleRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16f08f6abcc9049eULL;
  static const uint64_t static_value2 = 0x818ebd0c826029fcULL;
};

template<class ContainerAllocator>
struct DataType< ::object_handling::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::object_handling::exampleRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::object_handling::exampleRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::object_handling::exampleRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::object_handling::exampleRequest_<ContainerAllocator>& v)
  {
...
#endif // OBJECT_HANDLING_MESSAGE_EXAMPLEREQUEST_H
